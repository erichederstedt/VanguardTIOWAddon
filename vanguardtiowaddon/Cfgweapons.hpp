...
class Cfgweapons {
	...
	*/
	class VNG_MedGear: Cad_Gear2
	{
		...
		hiddenSelectionsTextures[]=
		{
			"CadFoot\Data\Textures\KasrArmor1_776_co.paa",
			"CadFoot\Data\Textures\KasrArmor2_776_co.paa",
			"euvanguardtiowaddon\Data\Textures\MED_FlakArmorReg_Vanguard_ca.paa"
		};
		class ItemInfo: ItemInfo
		{
			uniformModel="\CadFoot\Model\CadianKasrkinArmor.p3d";
	...
	*/
	...
	class VNG_Captain_Armor: ItemCore
	{
		...
		scopeArsenal=2;
		allowedSlots[]={901};
		//picture="euvanguardtiowaddon\Icon\empty.paa";
	...
	{
		author="1st legion";
		model="euvanguardtiowaddon\Model\VanguardDisposableLauncher.p3d";
		scope=0;
